...
void initWhite(){
       ...
       white[0].location = 56;
       white[0].alive = 1;
       strncpy (white[0].name, "Wr", sizeof(white[0].name));
       
       white[1].color = 1;
       white[1].moveCount = 0;
       white[1].location = 63;
       white[1].alive = 1;
       strncpy (white[1].name, "Wr", sizeof(white[1].name));
...
void initBlack(){
	...
	black[0].location = 0;
	black[0].alive = 1;
       strncpy (black[0].name, "Br", sizeof(black[0].name));

	black[1].color = 0;
	black[1].moveCount = 0;
	black[1].location = 7;
	black[1].alive = 1;
       strncpy (black[1].name, "Br", sizeof(black[1].name));
